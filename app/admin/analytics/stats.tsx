...
const Stats: React.FC = () => {
  return (
    <div className="w-full bg-white p-3 md:p-6 shadow-sm animate-in fade-in slide-in-from-top-2 duration-500 max-h-96 overflow-y-auto custom-scrollbar">
      ...
      <div className="bg-white rounded-2xl md:rounded-3xl border border-gray-200 shadow-xs overflow-hidden">
        ...
        <div className="flex flex-col md:flex-row border-t border-gray-100 bg-gray-50 p-4 md:p-6 gap-4 md:gap-6">
          <div className="flex-1 p-4 text-xs bg-white rounded-xl border border-gray-100">
